...
parser.add_argument('--bucket-size', type=int, default=100000000)
...
if __name__ == '__main__':
    ...
    # print(f"pp_deg:{pp_deg}, dp_deg:{dp_deg}, mp_deg:{mp_deg}")
    # print(f"pp_groups:{pp_groups}")
    # print(f"dp_groups:{dp_groups}")
    # print(f"mp_groups:{mp_groups}")
    # print(f"mesh:{mesh}")
    # raise 0
    ...
    if args.ps == 'pp':
        ...
        print(f"stree.root attributes: {dir(stree.root)}")
